...
class InitCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Mohit:init';
     ...
     * @var string
     */
    protected $description = 'Install Mohit';
    ...
    public function setAppEnvironmentDetails()
    {
        ...
        $this->env = $this->choice(
            'What environment are you installing Mohit on?',
            ['local', 'production'],
            $this->env
        );
    ...
    public function createSuperAdmin()
    {
        ...
        switch ($this->env) {
            case 'local':
                $this->info('Since you are trying out Mohit locally, we have already created a super admin account for you. Check the docs on what these credentials are if unsure');
                break;
            default:
                $this->info('If you choose to not create a super admin now for some reason, you cen do so late by running php artisan Mohit:create-super-admin');
                if ($this->confirm('Do you wish to create a super admin account now?', true)) {
                    $this->call('Mohit:create-super-admin');
                } else {
                    $this->line('skipping...');
                }
                break;
