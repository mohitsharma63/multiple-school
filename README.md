# Mohit school management system

<p align="center">
    <!-- <a href="https://packagist.org/packages//Mohit">
        <img src="https://poser.pugx.org//Mohit/d/total.svg" alt="Total Composer Downloads">
    </a> -->
    <a href="https://packagist.org/packages//Mohit">
        <img src="https://poser.pugx.org//Mohit/v/stable.svg" alt="Latest Stable Version">
    </a>
    <a href="https://packagist.org/packages//Mohit">
        <img src="https://poser.pugx.org//Mohit/license.svg" alt="License">
    </a>
</p>
...
# CONGRATS V2 OF Mohit IS OUT


Mohit is awesome, but it had a few shortcomings when it came to some areas like UI speed and application slugishness as it grows. Version 2 fixes these issues and also improves on accessibility. 
...
### Mohit is a multi school management system that aims to make school administration and activities a breeze by using the power of the internet and increased connectinity
...
```shell
git clone https://github.com//Mohit ./Mohit
 ```
...
Todo
- Create demo site (for now, go to .xyz might be a mess but worth it. Log in to super admin account with password helloworld)
- Create logo
